 ...
 correc4=[];
    ...
    //answe,
		...
		function llenarPreguntas(nuev,objec){
			...
			if(nivel=='B2' && extra=='14'){
				formuladas=0;
				limitepreguntas=5;
				hazpreguntaRB();
			}
			if(nivel=='B2' && extra=='15'){
				formuladas=0;
				limitepreguntas=5;
				hazPregunta();
			}
			if(nivel=='2B' && extra=='16'){
				formuladas=0;
				limitepreguntas=1;
				hazPregunta();
			}
			if(nivel=='2B' && extra=='17'){
				formuladas=0;
				limitepreguntas=1;
				hazPregunta();
			}
			if(nivel=='C1' && extra=='20'){
				formuladas=0;
				limitepreguntas=5;
				hazPregunta();
			}
			if(nivel=='1C' && extra=='18'){
				formuladas=0;
				limitepreguntas=1;
				hazPregunta();
			}
			if(nivel=='1C' && extra=='19'){
				formuladas=0;
				limitepreguntas=1;
				hazPregunta();
			}
...
//var fallid=0;
			...
			switch(tamaño){
				...
				case 1:
					...
					if(formuladas<limitepreguntas){
						...
						if(formuladas==limitepreguntas && nivel=='B2' && (item=='Grammar' || item=='Reading')){
							preguntasB2();
							formuladas=0;
						}
						if(formuladas==limitepreguntas && nivel=='2B' && item=='Listening'){
							preguntasAudiosB2();
							formuladas=0;
						}
						if(formuladas==limitepreguntas && nivel=='C1' && (item=='Grammar' || item=='Reading')){
							preguntasC1();
							formuladas=0;
						}
						if(formuladas==limitepreguntas && nivel=='1C' && item=='Listening'){
							preguntasAudiosC1();
							formuladas=0;
						}
			...
			if(contador==10 && nivel=='B2' && (item=='Reading' || item=='Grammar')){
					muestraResultado();
			}
			if(contador==2 && nivel=='2B' && item=='Listening'){
			//	alert('finaliza nivel B1 audios');
					muestraResultado();
			}
			if(contador==5 && nivel=='C1' && (item=='Reading' || item=='Grammar')){
					muestraResultado();
			}
			if(contador==2 && nivel=='1C' && item=='Listening'){
					muestraResultado();
			}
		});
		...
		//	alert('nivel actual : '+nivelactual);
			...
			$.ajax({
				...
				success:function(dat){
					...
					if(obj=='falseA1'){
						ocultarTodo();
						var result='Your Level is too low, Keep Working';
		...
		function preguntasB2(){
			nuevo.length=0;
			objetos.length=0;
			nuevo1.length=0;
		 // alert('contenido'+titulosB1);
			valor=numAleat(1,titulosB2.length-1);
			element=valor;
			tit = titulosB2.splice( valor, 1 );
		...
		function preguntasAudiosB2(){
			nuevo.length=0;
			objetos.length=0;
			nuevo1.length=0;
			//alert('contenido audios vector'+titulosAB1);
			valor=numAleat(1,titulosAB2.length-1);
			element=valor;
			tit = titulosAB2.splice( valor, 1 );
		...
		function preguntasC1(){
			nuevo.length=0;
			objetos.length=0;
			nuevo1.length=0;
		 // alert('contenido'+titulosB1);
			valor=numAleat(1,titulosC1.length-1);
			element=valor;
			tit = titulosC1.splice( valor, 1 );
		...
		function preguntasAudiosC1(){
			nuevo.length=0;
			objetos.length=0;
			nuevo1.length=0;
			//alert('contenido audios vector'+titulosAB1);
			valor=numAleat(1,titulosAC1.length-1);
			element=valor;
			tit = titulosAC1.splice( valor, 1 );
