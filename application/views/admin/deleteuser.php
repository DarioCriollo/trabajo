            ...
            <div class="box-body">
              <div class="row">
                <div class="form-group" align="right" style="margin-right:20px;">
                  <a href="<?php echo base_url ();?>C_administrador/registeradmin" type="submit" class="btn btn-success btn-lg"  name="button">New Student</a>
                </div>
              </div>
                <hr>
                <div class="row" >
                                ...
                                <?php if (!empty($datos)): ?>
                                    <?php foreach($datos as $dato):?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-warning"  onclick="updateAdmin(<?php echo $dato->id;?>);">Update</button>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
                                <?php endif ?>
