...
<div align="center" style="font-size:36px; color:black;">Update Menu</div>

	<div style="width: 800px; margin-left: 330px; color=red;">
		...
		<!-- <div class="contenedor" id="siete">
			<a href="<?php echo base_url ();?>administrador/deleteUser" ><img class="icon" src="<?php echo base_url();?>assets/dist/img/delete.png"></a>
