...
<html>
    ...
    <body>
            ...
            <div class="row">
              <div class="col-sm-6 blog-post">
                ...
                <div class="card card-cascade wider">
                  ...
                  <div class="view overlay">
                    <img src="<?php echo base_url();?>assets/dist/img/galeras.png" class="userfinal" /><br><br><br><br><br><br>
                    <a href="#!">
              ...
              <div class="col-sm-6 blog-post">
                <div class="card card-cascade wider">
                  ...
                  <!--Card image-->
                  <div class="view overlay">
                     <img src="<?php echo base_url();?>assets/dist/img/glyp3.png" class="userfinal" /><br><br><br><br><br><br>
                    <a href="#!">
                      <div class="mask rgba-white-slight"></div>
                    </a>
                  </div>
      ...
      <footer class="content-block content-block-dark">
             ...
             <div class="row">
              <div class="col-md-4">
                <!-- <p>&copy; Alfonso Joaquin Patiño Galarza </p>
                <p>&copy; Dario Fernando Criollo Estrada</p> -->
              </div>
              <div class="col-md-4">
